        ...
        <div class="row flex-grow">
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              ...
              <form action="register/create" method="POST" class="pt-3">
                @csrf
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input name="name" type="text" class="form-control form-control-lg border-left-0" placeholder="Username">
                  </div>
                </div>
                <div class="form-group">
                  <label>Email</label>
                ...
                <div class="text-center mt-4 font-weight-light">
                  Already have an account? <a href="/loginalumni" class="text-primary">Login</a>
                </div>
              </form>
            </div>
          </div>
